...
const BASE_URL =
  process.env.COINSWITCH_BASE_URL || "https://coinswitch.co";
...
export function signRequest(
  ...
  // CoinSwitch requires epoch in milliseconds
  ...
  // URLSearchParams encodes some chars; decode them back before signing
